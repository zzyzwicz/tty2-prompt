...
RSpec.describe TTY2::Prompt, "#expand" do
  ...
  it "fails to expand due to lack of key attribute" do
    ...
    }.to raise_error(TTY2::Prompt::ConfigurationError, /Choice Overwrite is missing a :key attribute/)
  end
  ...
  it "fails to expand due to wrong key length" do
    ...
    expect {
      prompt.expand("Overwrite Gemfile?", choices)
    }.to raise_error(TTY2::Prompt::ConfigurationError, /Choice key `long` is more than one character long/)
  end
  ...
  it "fails to expand due to reserve key" do
    ...
    expect {
      prompt.expand("Overwrite Gemfile?", choices)
    }.to raise_error(TTY2::Prompt::ConfigurationError, /Choice key `h` is reserved for help menu/)
  end
  ...
  it "fails to expand due to duplicate key" do
    ...
    expect {
      prompt.expand("Overwrite Gemfile?", choices)
    }.to raise_error(TTY2::Prompt::ConfigurationError, /Choice key `y` is a duplicate/)
  end
end
