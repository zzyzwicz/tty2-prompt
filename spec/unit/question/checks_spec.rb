...
RSpec.describe TTY2::Prompt::Question do
  ...
  it "passes range check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckRange.call(question, 2)

    expect(result).to eq([2])
  end

  it "fails range check" do
    question = described_class.new(prompt, messages: TTY2::Prompt.messages)
    question.in 1..10

    result = TTY2::Prompt::Question::Checks::CheckRange.call(question, 11)
  ...
  it "passes validation check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckValidation.call(question, "12345")
  ...
  it "fails validation check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckValidation.call(question, "123")
  ...
  it "fails validation check with inlined custom message" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckValidation.call(question,
                                                                 "piotr@com")
  ...
  it "passes required check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckRequired.call(question, "Piotr")
  ...
  it "fails required check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckRequired.call(question, nil)
  ...
  it "passes convert check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckConversion.call(question, "t")
  ...
  it "fails convert check" do
    ...
    result = TTY2::Prompt::Question::Checks::CheckConversion.call(question, "x")
